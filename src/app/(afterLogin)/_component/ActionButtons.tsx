...
export default function ActionButtons({ white, post }: Props) {
  ...
  const heart = useMutation({
    mutationFn: () => {
      return fetch(
        `${process.env.NEXT_PUBLIC_BASE_API}/api/posts/${postId}/heart`,
        {
          method: 'post',
          credentials: 'include',
        },
  ...
  const repost = useMutation({
    mutationFn: () => {
      return fetch(
        `${process.env.NEXT_PUBLIC_BASE_API}/api/posts/${post.postId}/reposts`,
        {
          method: 'post',
          credentials: 'include',
        },
  ...
  const onClickComment: MouseEventHandler<HTMLButtonElement> = (e) => {
    ...
    // fetch(`${process.env.NEXT_PUBLIC_BASE_API}/api/posts/${post.postId}/comments`, {
    //   method: 'post',
    //   credentials: 'include',
    //   body: formData
    // });
